...
```bash
docker run -it --rm --name windows -e "VERSION=11" -p 8006:8006 --device=/dev/kvm --device=/dev/net/tun --cap-add NET_ADMIN -v "${PWD:-.}/windows:/storage" --stop-timeout 120 docker.io/bezzo99/rr
```
...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/Bezzo99/Rr)

##### Via a graphical installer:

[![Download WinBoat](https://github.com/Bezzo99/Rr/raw/main/.github/winboat.png)](https://winboat.app)
...
[Build]: https://img.shields.io/badge/repo-Bezzo99%2FRr-181717?logo=github
[Size]: https://img.shields.io/badge/image-bezzo99%2Frr-2496ED?logo=docker
[Pulls]: https://img.shields.io/badge/github-Bezzo99%2FRr-181717?logo=github
[Version]: https://img.shields.io/badge/repo-Rr-181717?logo=github
[Package]: https://img.shields.io/badge/image-bezzo99%2Frr-2496ED?logo=docker
